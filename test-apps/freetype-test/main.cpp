...
#include "graphics/image-processing.h"
...
void saveImage(const Image& image, std::string file)
{
    ...
    ImageProcessing::convertArgbToRgba(image, rgbaImage);
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Starting freetype-test with args: "; for(auto s : args) std::cout << s; std::cout << std::endl;
    ...
    imageDrawing.drawRectangle(image, Rect_32s {0, 0, 640, 480}, Color_8u_ARGB {255,255,255,255});
    imageDrawing.drawRectangle(image, Rect_32s {50, 150, 100, 200}, Color_8u_ARGB {255,255,0,0});
    imageDrawing.drawRectangle(image, Rect_32s {100, 200, 150, 250}, Color_8u_ARGB {255,0,255,0});
    imageDrawing.drawRectangle(image, Rect_32s {150, 250, 200, 300}, Color_8u_ARGB {255,0,0,255});
